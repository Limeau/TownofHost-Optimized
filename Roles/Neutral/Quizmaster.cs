    ...
    private void DoQuestion()
    {
        ...
        if (MarkedPlayer != byte.MaxValue)
        {
            ...
            [
                ...
                new SetAnswersQuestion { Stage = 5, Question = "TOHONuker", Answer = "Ape", PossibleAnswers = { "Lime", "Sarha", "Mirage", "Jackler", "Zuzu", "Tasha", "Moe", "Dailyhare" }, QuizmasterQuestionType = QuizmasterQuestionType.TOHOEventCoordinator },
