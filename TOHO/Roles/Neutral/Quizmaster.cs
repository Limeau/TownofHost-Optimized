    ...
    private void DoQuestion()
    {
        ...
        if (MarkedPlayer != byte.MaxValue)
        {
            ...
            [
                ...
                new SetAnswersQuestion { Stage = 5, Question = "HowManyCats", Answer = "3", PossibleAnswers = { "0", "1", "2", "3", "4", "5", "6" }, QuizmasterQuestionType = QuizmasterQuestionType.HowManyCats }, // Copycat, Schrodinger's Cat, Oblivion (I want to count Jinx because of its origin in TOS2, but I won't)
