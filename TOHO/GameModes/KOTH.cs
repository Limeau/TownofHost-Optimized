...
internal static class KOTH
{
    ...
    public static SystemTypes CurrentRoom = SystemTypes.HeliSabotage;
    ...
    public static void SetKillCooldown(PlayerControl player) => Main.AllPlayerKillCooldown[player.PlayerId] = KillCooldown.GetFloat();
    ...
    public static List<SystemTypes> RoomsList = [];
    ...
    public static void SetData()
    {
        ...
        CurrentRoom = SystemTypes.HeliSabotage;
    ...
    public static string GetProgressText(byte playerId)
    {
        ...
        if (CurrentRoom == SystemTypes.HeliSabotage) progressText = $"\nStarting game soon... - <color={player.GetRoleColorCode()}>({Points[player]})</color>\n";
    ...
    class UpdateInGameModeKothPatch
    {
        ...
        public static void Postfix()
        {
            ...
            if (SwitchTime <= 0)
            {
                CurrentRoom = KOTH.RoomsList.FirstOrDefault();
                KOTH.RoomsList.Remove(CurrentRoom);
                KOTH.RoomsList.Add(CurrentRoom);
            ...
            foreach (var player in Main.AllAlivePlayerControls)
            {
                ...
                if (CurrentRoom == SystemTypes.HeliSabotage) return;
