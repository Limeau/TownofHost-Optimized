...
class UpdateSystemPatch
{
        ...
        [HarmonyArgument(2)] byte amount)
    {
        ...
        if ((Options.CurrentGameMode == CustomGameMode.FourCorners || Options.CurrentGameMode == CustomGameMode.BeanTrials || Options.CurrentGameMode == CustomGameMode.FFA || Options.CurrentGameMode == CustomGameMode.UltimateTeam || Options.CurrentGameMode == CustomGameMode.TrickorTreat) && systemType == SystemTypes.Sabotage) return false;
