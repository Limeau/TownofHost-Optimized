...
class RpcSetTasksPatch
{
    ...
    public static bool Prefix(NetworkedPlayerInfo __instance)
    {
        ...
        if (pc.Is(CustomRoles.GM) || pc.Is(CustomRoles.LazyGuy) || pc.Is(CustomRoles.Lazy) || Options.CurrentGameMode == CustomGameMode.FFA || Options.CurrentGameMode == CustomGameMode.BeanTrials || Options.CurrentGameMode == CustomGameMode.UltimateTeam)
        {
            hasCommonTasks = false;
            NumShortTasks = 0;
            NumLongTasks = 0;
